...
class IndexController extends Controller
{
    public function Index(){
       ...
       $innovators = Innovator::latest()->get();
       ...
       return view('frontend.index',compact('categories','sliders','innovators','products','featured','hot_deals','special_offer','special_deals','skip_category_0','skip_product_0','skip_category_1','skip_product_1','skip_brand_1','skip_brand_product_1', 'Allcourses'));
   ...
   $list_view = view('frontend.product.list_view_product',compact('products'))->render();
    ...
    public function ProductViewAjax($id){
        $mapId = Map::where('kit_id', $id)->get()->first();
        $courseId = $mapId->course_id;
