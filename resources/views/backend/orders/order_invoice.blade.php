  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: blue; font-size: 26px;"><strong>Future Gurukuls</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               Future Gurukuls Head Office
               Email:support@futuregurukuls.in <br>
               Mob: 6387894347 <br>
               12k Natwa SK Nagar, UP <br>
    ...
    <tr>
        <td>
          <p class="font" style="margin-left: 20px;">
           ...
           <strong>Address:</strong> {{ $div }},{{ $dis }}.{{ $state }}, {{$notes}}<br>
