    ...
    <section class="home-career">
        ...
        <div class="career-items">
            <a href="#" class="item">
                <div class="item-img">
                    <img loading="lazy"
                        src="{{asset('fronten/assets/images/icon/robotics.png')}}"
                        alt="Roboticist" class="img" >
                </div>
            ...
            <a href="#" class="item">
                <div class="item-img">
                    <img loading="lazy"
                        src="{{asset('fronten/assets/images/icon/app.png')}}"
                        alt="Game Designer" class="img" data-v-0a4c26ff="">
                </div>
            ...
            <a href="#" class="item">
                <div class="item-img">
                    <img loading="lazy"
                        src="{{asset('fronten/assets/images/icon/iot.png')}}"
            ...
            <a href="#" class="item">
                <div class="item-img"><img loading="lazy"
                        src="{{asset('fronten/assets/images/icon/drone.png')}}"
   ...
   <div class="container coding-iot-robotics">
       ...
       smart_toy
           ...
           <div class="col-4 " id="b" style="padding:15px 5px 5px 5px;">
                <a href="#courses" id="jscourse" class="cir-icon-course"> <span class="material-icons-outlined span-icon">
                smart_display
    </span><h6>Courses</h6></a>
           </div>
           <div class="col-4" id="c" style="padding:15px 5px 5px 5px;">
                <a href="#components" id="jscomponent" class="cir-icon-component"> <span class="material-icons-outlined span-icon" >
...
<div class="gradient-custom-innovator">
    ...
    <div class="carousel-item active">
                ...
                <div class="col-lg-6 col-md-6 col-6">
                    <div class="video-card">
                        ...
                        src="https://www.youtube.com/embed/iAeO-TFTOGM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                        </iframe>
                    </div>
                </div>
  ...
  <a class="carousel-control-prev" href="#carouselInnovatorMobile" role="button" data-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="carousel-control-next" href="#carouselInnovatorMobile" role="button" data-slide="next">
    <span class="carousel-control-next-icon" aria-hidden="true"></span>
    <span class="sr-only">Next</span>
  </a>
</div>
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-12">
                <div class="testinomial-grid-img">
                    <img src="{{asset('fronten/assets/images/testinomial/mt.jpg')}}">
                </div>
             ...
             <div class="col-lg-8 col-md-8 col-12">
                ...
                <h6>Principal, Rameshwar Prasad Satya Narayan Inter College, Ayodhya</h6>
                <p></p>
                </div>
    ...
    <div class="carousel-item">
        ...
        <div class="testinomial-grid">
          <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-12">
                <div class="testinomial-grid-img">
                    <img src="{{asset('fronten/assets/images/testinomial/pp.jpg')}}">
                </div>
    ...
    <div class="carousel-item">
        ...
        <div class="testinomial-grid">
          <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-12">
                <div class="testinomial-grid-img">
                    <img src="{{asset('fronten/assets/images/testinomial/aj.jpg')}}">
                </div>
             ...
             <div class="col-lg-8 col-md-8 col-12">
                ...
                <p>At vero eos et accusamus et iusto odio dignissimos qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia mollitia animi id laborum et dolorum fuga.</p>
                </div>
    ...
    <div class="container award ">
      ...
      <img src="{{asset('fronten/assets/images/media/award.jpg')}}" alt="">
        ...
        <div class="col-lg-6 col-md-6 col-12 award-text">
            ...
            <p>We are incubated at Atal Incubation Centre Pondicherry. And we have been selected under Startup India seed fund scheme.</p>
        </div>
                    ...
                    <div id="news-slider" class="owl-carousel">
                        <div class="post-slide">
                            <div class="post-img">
                                <a href="#">
                                    <img class="pic-1"
                                        src="{{asset('fronten/assets/images/media/1.jpg')}}">
                                 
                                </a>
                            </div>
                            <div class="post-review">
                                <h3 class="post-title"><a href="#">Media is covering our hard work</a></h3>
                                <p class="post-description">A local news paper has covered our hard work. We teach Robotics, Drone technology, coding, IoT etc. to school students.</p>
                            </div>
                        </div>
                        ...
                        <div class="post-slide">
                            <div class="post-img">
                                <a href="#">
                                    <img class="pic-1"
                                        src="{{asset('fronten/assets/images/media/3.jpg')}}">
                        ...
                        <div class="post-slide">
                            <div class="post-img">
                                <a href="#">
                                    <img class="pic-1"
                                        src="{{asset('fronten/assets/images/media/2.jpg')}}">
                                   
                                </a>
                            </div>
                            <div class="post-review">
                                <h3 class="post-title"><a href="#">Hindustan newspaper</a></h3>
                                <p class="post-description">One of the famous newspaper in India, Hindustan covered story of our students.</p>
                            </div>
                        </div>
                            ...
                            <div class="post-img">
                                <a href="#">
                                    <img class="pic-1"
                                        src="{{asset('fronten/assets/images/media/4.jpg')}}">
                     ...
                     <!----- @foreach($brands as $brand)
                        ...
                        <div class="slide" style="width: 174px; outline: none;">
                            <div class="partners-item-container" style="width: 100%; display:inline-block;">
                                <div class="partners-item">
                                    <img
                                        src="{{asset('fronten/assets/images/support/aicpecf.png')}}">
                                </div>
                            </div>
                        </div>
                        <div class="slide" style="width: 174px; outline: none;">
                            <div class="partners-item-container" style="width: 100%; display:inline-block;">
                                <div class="partners-item">
                                    <img
                                        src="{{asset('fronten/assets/images/support/startup.png')}}">
                                </div>
                            </div>
                        </div>
                        <div class="slide" style="width: 174px; outline: none;">
                            <div class="partners-item-container" style="width: 100%; display:inline-block;">
                                <div class="partners-item">
                                    <img
                                        src="{{asset('fronten/assets/images/support/sisf.png')}}">
                                </div>
                            </div>
                        </div>
                        <div class="slide" style="width: 174px; outline: none;">
                            <div class="partners-item-container" style="width: 100%; display:inline-block;">
                                <div class="partners-item">
                                    <img
                                        src="{{asset('fronten/assets/images/support/dpiit.png')}}">
                                </div>
                            </div>
                        </div>
                                                <div class="slide" style="width: 174px; outline: none;">
