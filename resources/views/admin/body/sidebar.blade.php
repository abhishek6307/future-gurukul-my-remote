				 ...
				 <a href="index.html">
				  <!-- logo for regular state and mobile devices -->
					 <div class="d-flex align-items-center justify-content-center">					 	
						  <img src="{{ asset('backend/images/logofg.svg')}}" alt="">
					 </div>
				 </a>
			</div>
        </div>
      ...
      @if($product == true)
        ...
        <li class="treeview {{ ($prefix == '/slider')?'active':'' }}  ">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ ($route == 'innovate-slider')? 'active':'' }}"><a href="{{ route('innovate-slider') }}"><i class="ti-more"></i>Innovator Slider</a></li>
        ...
        <li class="header nav-small-cap">Manage Courses</li>

          <li class="treeview {{($prefix == '/coursecategory')?'active':''}}">
          <a href="#">
            <i data-feather="mail"></i> <span>Course Category</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="{{($route == 'course.category')?'active':''}}"><a href="{{route('course.category')}}"><i class="ti-more"></i>All Category</a></li>
          ...
          <ul class="treeview-menu">
            <li class="{{ ($route == 'add-course')? 'active':'' }}"><a href="{{ route('add-course') }}"><i class="ti-more"></i>Add Course</a></li>

             <li class="{{ ($route == 'manage-course')? 'active':'' }}"><a href="{{ route('manage-course') }}"><i class="ti-more"></i>Manage Course</a></li>

             <li class="{{ ($route == 'add-video')? 'active':'' }}"><a href="{{ route('add-video') }}"><i class="ti-more"></i>Upload Video</a></li>

             <li class="{{ ($route == 'manage-video')? 'active':'' }}"><a href="{{ route('manage-video') }}"><i class="ti-more"></i>Manage Video</a></li>

             <li class="{{ ($route == 'map-kit-course')? 'active':'' }}"><a href="{{ route('map-kit-course') }}"><i class="ti-more"></i>Map Kit-Course</a></li>
